...
class Trainer:
    ...
    def resume_training(self, path: str):
        ...
        self.val_stats["best_wer"] = checkpoint["wer"]
    ...
    def save_model(self):
        ...
        if self.val_stats["wer"] < self.val_stats["best_wer"]:
            ...
            self.val_stats["best_wer"] = self.val_stats["wer"]
